...
class APlayer_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function playercss()
    {
        ...
        echo '
<!-- APlayer Start -->
<link rel="stylesheet" type="text/css" href="'.$playerurl.'APlayer.min.css" media="print" onload="this.media=\'all\'; document.documentElement.classList.add(\'aplayer-ready\')" />
