...
class Prism_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function headlink($cssUrl) {
        ...
        $links = '<link rel="stylesheet" type="text/css" href="'.$url.'css/prism-'.$settings->style.'.css"  media="print" onload="this.media=\'all\'" />';
        echo $links;
    }
...
<script>
(function(){
    var codeEl = document.querySelector('code[class*="lang-"]');
    if (codeEl) {
        var script = document.createElement('script');
        script.type = 'text/javascript';
        script.src = '{$url}js/prism.js';
